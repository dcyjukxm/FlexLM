 ...
 *****************************************************************************/
/*	
 *	Module: $Id: hostx.c,v 1.3 2003/01/13 21:58:47 kmaclean Exp $
 *
 *	Function:	hostx main -- tests lmhostx.c stubs
 *
 *	D. Birns
 *	7/16/96
 *
...
main()
{
  ...
  extern char *l_asc_hostid lm_args((LM_HANDLE *, HOSTID *));
	...
	if (!(h = lc_gethostid(lm_job)))
		lc_perror(lm_job, "lc_gethostid failed");
	puts(l_asc_hostid(lm_job, h));
}
