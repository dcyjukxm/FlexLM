...
#user name and password maillist is $npOUT
npOUT=namepasswd.`date '+%Y.%m.%d'`
echo "name and password maillist in " $npOUT
cp $mOUT $npOUT

#add special cases to $npOUT
echo 'pattyh@globes.com' >> $npOUT
echo 'mickijo@globes.com' >> $npOUT
echo 'support_qa@globes.com' >> $npOUT
echo 'andym@globes.com' >> $npOUT
echo 'karenh@globes.com' >> $npOUT
echo 'info@globes.com' >> $npOUT
echo 'orders@globes.com' >> $npOUT
