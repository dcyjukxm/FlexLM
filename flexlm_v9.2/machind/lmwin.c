/******************************************************************************
	    ...
	    COPYRIGHT (c) 1995-1999 by Macrovision Corporation.
 ...
 *****************************************************************************/
/*	
 *	Module: $Id: lmwin.c,v 1.9 2002/09/30 20:43:59 jwong Exp $
 *
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
  ...
  HWND hButton ;
	...
	hButton = GetDlgItem( hwnd, IDC_ORDERNUMBERS ); 
        SetWindowText(hButton, "(NOTE: Use OR6802-4864392 [LM_STRENGTH_LICENSE_KEY] or \r\nOR10660-2377213 [LM_STRENGTH_DEFAULT] as the key)");
		...
		case IDC_CHECKOUT:
			...
			if ( !FeatureName[0] )
				strcpy(FeatureName,"f1");
                        ...
                        ShowCursor(TRUE);
			rc = CHECKOUT( LM_RESTRICTIVE | LM_FLEXLOCK , 
                                FeatureName, "1.0", LICENSE_PATH );
