 ...
 *****************************************************************************/
/*	
 *	Module: $Id: lm_lerr.h,v 1.39 2003/06/09 15:31:51 sluu Exp $
 *
...
/* BADFILE */		0,
/* NOSERVER */		
"There is a license server/vendor daemon running, but it's for\n\
other vendors.",
/* MAXUSERS */		0,
/* NOFEATURE */		0,
/* NOSERVICE */		0,
...
/* NOBORROWSUPP */	0,
/* LM_NOTONSERVER */ 	
" This error can occur because the server isn't running, or\n\
 the application needs to add @localhost with the lmpath command",
/* LM_BORROWLOCKED */
