/************************************************************************
        ...
        COPYRIGHT (c) 2003 by Macrovision Corp.
...
int WINAPI lt_checkout(iPolicy, szFeatureName, szFeatureVer, szLicFileList)
int iPolicy;
char *szFeatureName;
char *szFeatureVer;
char *szLicFileList;
...
void WINAPI lt_perror(szErrStr)
char* szErrStr;
{
	PERROR(szErrStr);
}
