 ...
 *****************************************************************************/
/*
 *	Module: $Id: lsvendor.c,v 1.52 2003/06/16 18:05:13 jwong Exp $
 *
 *	Function:  None
 *
...
char *(*ls_user_lock)() = NULL;         /* callback routine for semaphore name change */
