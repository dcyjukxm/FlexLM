 ...
 *****************************************************************************/
/*
 *	Module: $Id: demof2.c,v 1.35 2003/05/15 23:09:22 jwong Exp $
 *
 *	Function:  None
 *
...
#undef VENDOR_NAME
#define VENDOR_NAME "demof2"


VENDORCODE vendorkeys[] = {		/* Possible keys for vendor daemons */
		{ VENDORCODE_6, ENCRYPTION_SEED1^VENDOR_KEYf2_5, 
		ENCRYPTION_SEED2^VENDOR_KEYf2_5,
		VENDOR_KEYf2_1, VENDOR_KEYf2_2, VENDOR_KEYf2_3, VENDOR_KEYf2_4, 
...
char * ls_a_behavior_ver = 0;	/* like LM_A_COMPATIBILITY */
