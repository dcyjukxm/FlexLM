 ...
 *****************************************************************************/
/*
 *	Module: $Id: demof.c,v 1.38 2003/05/15 23:09:22 jwong Exp $
 *
 *	Function:  None
 *
...
#undef VENDOR_NAME
#define VENDOR_NAME "demof"


VENDORCODE vendorkeys[] = {		/* Possible keys for vendor daemons */
		{ VENDORCODE_6, ENCRYPTION_SEED1^VENDOR_KEYf_5, 
		ENCRYPTION_SEED2^VENDOR_KEYf_5, VENDOR_KEYf_1, VENDOR_KEYf_2, 
			VENDOR_KEYf_3, VENDOR_KEYf_4, 
				FLEXLM_VERSION, 
			FLEXLM_REVISION, FLEXLM_PATCH, LM_BEHAVIOR_CURRENT,
			{CRO_KEY1, CRO_KEY2},
...
#if 0
int ls_use_featset = 1;		/* Use the FEATURESET line from the license
									file */
#else
...
int ls_a_check_baddate = 1;	
int ls_a_lkey_start_date = 1;		
int ls_a_lkey_long = 1;		
