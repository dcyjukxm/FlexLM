...
/*	
 *	Module: $Id: l_sha.c,v 1.2 2003/03/06 02:21:18 jwong Exp $
 *
 *	SHA-1 Module
 *
 *	J. Wong
...
/************************************************************************************** 
	...
	This code is a public domain SHA-1 algorythm originally published in the book
	"Applied Cryptography". This code is a comglomeration of all the seperate header
	files and source that was orginally presented, in order to make a single file for
	ease of reference and building.
