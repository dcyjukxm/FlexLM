...
Public Class FLEXlm_dll
    ...
    Public Const LM_FLEXLOCK As Integer = &H1000

    Public Declare Ansi Function VB_CHECKOUT Lib "lmgr8c.dll" _
    Alias "lt_checkout" (Byval policy as Integer, _
                         ByVal fname As String, _
                         ByVal fver As String, _
                         ByVal licpath As String) As Integer

    Public Declare Ansi Function VB_CHECKIN Lib "lmgr8c.dll" _
    Alias "lt_checkin" () As Integer

    Public Declare Ansi Function VB_HEARTBEAT Lib "lmgr8c.dll" _
    Alias "lt_heartbeat" () As Integer
    Public Declare Ansi Function VB_ERRSTRING Lib "lmgr8c.dll" _
    Alias "lt_errstring" () As String
    Public Declare Ansi Function VB_PERROR Lib "lmgr8c.dll" _
    Alias "lt_perror" (ByVal errstr as String) As Integer
    Public Declare Ansi Function VB_PWARN Lib "lmgr8c.dll" _
    Alias "lt_pwarn" (ByVal errstr as String) As Integer
    Public Declare Ansi Function VB_WARNING Lib "lmgr8c.dll" _
