...
*  Module Description:
*  ------------------
*  This source is meant as a skeleton interface to FLEXlm's Flexible API
*  in order for users of development platforms such as Visual Basic 
*  and Delphi to have access to CRO. 
*
*  In order to create this DLL properly a developer must link into this 
*  library a copy of the lm_new.obj that is created in the FLEXlm toolkit 
...
*	- Text editor.
*       - Installed FLEXlm toolkit.
*	- valid vendor codes from Macrovision Corporation..
*	- lm_new.obj file generated by the FLEXlm toolkit.
*
************************************************************************/
...
*  Function	lp_setup
*
*  Description	To initialize FLEXlm flexible API in order to create a
*		valid job handle.
*
